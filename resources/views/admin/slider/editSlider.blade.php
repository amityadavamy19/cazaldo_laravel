            ...
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill h3 my-2">
                        Slider Management<small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted">Edit Slider</small>
                    </h1>
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            <li class="breadcrumb-item">Sliders</li>
                            <li class="breadcrumb-item" aria-current="page">
                                <a class="link-fx" href="">Edit Slider</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box box-primary">
                                    ...
                                    {!! Form::open(['url' => 'admin/editSlider','files'=>'true']) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::image(asset('uploads/slider/'.$data->image),null, ['class'=>'form-control']) }}
                                                    {{ Form::hidden('old_image',$data->image, ['class'=>'form-control']) }}
