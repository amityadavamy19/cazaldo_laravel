                            ...
                            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-alt">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">
                                        <a class="link-fx" href="">Edit Blog</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
        ...
        <div class="col-md-12">
          <!-- general form elements -->
            ...
            <div class="box box-primary">
                ...
                {!! Form::open(['url' => 'admin/editBlog','files'=>'true']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                {{ Form::label('Thumbnail', null, ['class' => 'control-label']) }}
                                   ...
                                   {{ Form::image(asset('uploads/'.$data->thumbnail),null, ['class'=>'form-control']) }}
                                   {{ Form::hidden('old_thmb',$data->thumbnail, ['class'=>'form-control']) }}
